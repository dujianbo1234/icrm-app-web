<template>
	...
	<!-- 登门拜访 -->
	<van-popup class="dmbf" v-model:show="showVisit" round position="bottom" z-index="99999"
		...
		<div class="popPlate2">
			<div class="cameraBox" v-for="(photo, i) in photoList" :key="'photo' + i">
				<van-icon class="delBtn" :name="require('@/assets/image/common_delete.png')" color="##8C8C8C" size="20"
					@click="delPhoto(i)" />
