	...
	<van-popup v-model:show="showSecret" round :close-on-click-overlay="false"
		...
		<div class="secretBox">
			...
			<div class="secretValue">
				...
				<div style="text-align: right;margin-top: 0.1rem;">承诺人：{{$store.state.userMsg.empname}}</div>
				<div style="text-align: right;margin-bottom: 0.1rem;">工号：{{$store.state.userMsg.empid}}</div>
			...
			<div class="secretBtn">
				...
				<div :class="checked?'secretBtn_confirm_a':'secretBtn_confirm'" @click="confirmSecret">确认</div>
			</div>
		</div>
	</van-popup>
</template>
